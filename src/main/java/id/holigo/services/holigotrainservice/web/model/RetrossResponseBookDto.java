...
@NoArgsConstructor
@AllArgsConstructor
public class RetrossResponseBookDto implements Serializable {
    ...
    @JsonProperty("DiskonDep")
    private BigDecimal discountDep;
    ...
    @JsonProperty("DiskonRet")
    private BigDecimal discountRet;
